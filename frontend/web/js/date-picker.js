!function () {
    ...
    !function () {
        ...
        var e = function (t) {
            ...
            N = "div.".concat(v, "-footer"), j = "div.".concat(v, "-btn-today"), V = "div.".concat(v, "-btn-empty"),
            P = "div.".concat(v, "-btn-close"), B = "div.".concat(v, "-time-container"), H = "div.".concat(v, "-time"),
            Y = "not-in-range", k = "holly-day", L = "".concat(v, ":change"), z = "click", R = "focusin", J = "today",
            ...
            G = "block", K = "none", Q = function t(n) {
                ...
                t && (t.dispatchEvent(U(n)), n === L && (t.dispatchEvent(U("change")), t.dispatchEvent(U("input"))))
            }, $ = function (t, n, i, a, r) {
                var s = t.split(".");
                t = s.shift() || "div";
        ...
        var at, rt, st = function (t, n) {
            ...
            pt(t), function (t) {
                ...
                for (var o = function (n) {
                    ...
                    a.inBeforeMonth = a.day <= f && e < f, a.inAfterMonth = e >= r + f, (a.inBeforeMonth || a.inAfterMonth) && (a.inBeforeMonth ? (v++, a.day = v, a.year = m, a.month = d) : (g++, a.day = g, a.year = l, a.month = c)), a.isValid = p(t, a.year, a.month, a.day), a.className = ht(it(a.year, a.month, a.day)), t.inputValue.day === a.day && t.inputValue.year === a.year && t.inputValue.month === a.month && (a.className += ".".concat("selected")), t.today.day === a.day && t.today.year === a.year && t.today.month === a.month && (a.className += ".".concat("today")), i(t.options.dayRendering) && s(a, t.options.dayRendering(a, t.input)), a.isHollyDay && (a.className += ".".concat(k));
                    var u = a.isValid ? x : M;
            ...
            var n, e = $(N, t.dpContainer);
            if (t.options.showTodayBtn && t.options.date) {
                var i = function (t) {
                    return p(t, t.today.year, t.today.month, t.today.day)
                }(t);
                $(j + (i ? "" : ".disabled-btn"), e, z, (function () {
                    i && t.setValue(t.today)
                }), "امروز")
            }
            t.options.date || !t.options.time || null !== (n = t.input) && void 0 !== n && n.value || $(j, e, z, (function () {
                t.setValue(t.initTime), t.hide()
            }), "انتخاب"), t.options.showEmptyBtn && $(V, e, z, (function () {
                t.input.value = "", Z(t.input, L), t.options.hideAfterChange && t.hide()
            }), "خالی"), t.options.showCloseBtn && $(P, e, z, (function () {
                t.hide()
            }), "بستن")
        }, yt = function (t) {
        ...
        var ft = /iphone|ipod|android|ie|blackberry|fennec/.test(null === (at = window.navigator) || void 0 === at || null === (rt = at.userAgent) || void 0 === rt ? void 0 : rt.toLowerCase()),
            vt = {
                init: function (t) {
                    var n;
                    this.updateOptions(t), window.onresize = _t, this.options.autoHide && (document.body.onclick = wt), this.options.autoShow && (n = this.options.selector, Element.prototype.matches = Element.prototype.matchesSelector || Element.prototype.mozMatchesSelector || Element.prototype.msMatchesSelector || Element.prototype.oMatchesSelector || Element.prototype.webkitMatchesSelector, document.body.addEventListener(R, (function (t) {
                ...
                get initDate() {
                    return this._initDate || (this._initDate = a(this.input.value) || {}, r(this._initDate) ? this._initDate = this.options.initDate || a(this.today) : o(this._initDate) && y(this, this._initDate) ? this._initDate = m(this, this._initDate) : this._initDate = a(this.today), this._initDate = d(this, this._initDate)), this._initDate
                },
                get initTime() {
